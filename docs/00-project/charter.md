...
2. Menyediakan hasil, jadwal, bracket, klasemen, dan daftar PD PERPAMSI untuk publik.
...
2. Master data event, provinsi, PD PERPAMSI, cabor, kategori, peraturan, venue, agenda, dan pemain.
3. Verifikasi peserta dan dokumen dasar.
4. Jadwal, match, input skor, finalisasi, dan revisi skor.
5. Hasil, bracket knockout dasar, klasemen cabor, dan klasemen medali PD PERPAMSI.
