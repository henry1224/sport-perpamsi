...
2. Menyediakan live score, jadwal, bracket, klasemen, ranking, dan profil PDAM untuk publik.
...
2. Master data event, PDAM, cabor, kategori, venue, tim, atlet.
3. Verifikasi peserta dan dokumen dasar.
4. Jadwal, match, input skor, finalisasi, dan revisi skor.
5. Live score, bracket knockout dasar, klasemen sederhana, ranking PDAM.
