export const statusLabel = (status) => ({
  ...
  registration_draft: 'Draft', registration_open: 'Pendaftaran Dibuka', registration_closed: 'Pendaftaran Ditutup', participants_locked: 'Peserta Dikunci', bracket_locked: 'Bracket Dikunci',
