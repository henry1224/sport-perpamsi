...
<template>
  <PortalLayout portal="pd">
    ...
    <AdminDataTable :paginator="events" :filters="filters" item-label="kompetisi" search-placeholder="Cari cabor, kategori, kode, atau kompetisi" :filter-options="[{ value: 'registration_open', label: 'Pendaftaran Dibuka' }, { value: 'registration_closed', label: 'Pendaftaran Ditutup' }, { value: 'participants_locked', label: 'Peserta Dikunci' }, { value: 'bracket_locked', label: 'Bracket Dikunci' }, { value: 'ongoing', label: 'Sedang Berlangsung' }, { value: 'completed', label: 'Selesai' }]" v-slot="{ rows }">
