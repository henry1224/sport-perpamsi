  ...
  <PublicLayout>
    ...
    <section class="login-panel">
      <form @submit.prevent="submit" class="login-form">
        ...
        <PasswordField v-model="form.password" label="Kata Sandi" autocomplete="current-password" required theme="dark" square :error="form.errors.password" />
...
.login-form input[type=email] { padding: 12px 14px; color: #fff; background: #08142d; border: 1px solid rgba(255,255,255,.16); font: inherit; }
