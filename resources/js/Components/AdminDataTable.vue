...
<style scoped>
.admin-table-card { overflow: hidden; color: #172535; background: #fff; border: 1px solid #dbe5ea; box-shadow: 10px 10px 0 rgba(25,70,163,.1); }
.table-toolbar { display: grid; grid-template-columns: minmax(260px, 1fr) 220px 150px; gap: 14px; padding: 18px 20px; background: #f8fafb; border-bottom: 1px solid #dbe5ea; }
label { display: grid; gap: 7px; }
label span { color: #60717f; font-size: 10px; font-weight: 900; letter-spacing: .12em; text-transform: uppercase; }
input, select { width: 100%; min-height: 42px; padding: 10px 12px; color: #172535; background: #fff; border: 1px solid #cbd8df; outline: none; }
...
:deep(th) { padding: 13px 16px; color: #60717f; background: #f8fafb; border-bottom: 1px solid #dbe5ea; font-size: 10px; font-weight: 950; letter-spacing: .12em; text-align: left; text-transform: uppercase; white-space: nowrap; }
...
:deep(.primary-cell strong) { color: #102132; font-size: 14px; font-weight: 850; }
:deep(.primary-cell small) { color: #738390; }
:deep(.status-badge) { display: inline-flex; align-items: center; width: fit-content; min-height: 27px; padding: 5px 9px; color: #655000; background: #fff2c8; border: 1px solid #f2dda0; font-size: 10px; font-weight: 950; letter-spacing: .06em; text-transform: uppercase; }
...
:deep(.row-actions button) { min-height: 34px; padding: 7px 10px; color: #1946a3; background: #fff; border: 1px solid #cbd8df; font-size: 10px; font-weight: 950; letter-spacing: .06em; text-transform: uppercase; cursor: pointer; }
...
nav button { min-height: 36px; padding: 8px 12px; color: #1946a3; background: #fff; border: 1px solid #cbd8df; font-weight: 850; cursor: pointer; }
